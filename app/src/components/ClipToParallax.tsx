...
export default function ClipToParallax({ pageId, sourceId, sourceTitle, selectionText, sourceLocation }: Props) {
  ...
  return (
    <button
      ...
      title={!selectionText ? 'Select a passage to clip' : 'Clip to Parallax'}
    >
      {done ? 'Clipped' : loading ? 'Clipping…' : 'Clip to Parallax'}
    </button>
  );
}
