...
export default function ComparativeTable({
  ...
  const conceptPairs = useMemo(() => {
    const pairs: Array<{
      concept1: ParallaxConcept;
      concept2: ParallaxConcept;
      similarity: number;
      relationship: ParallaxRelationship;
    }> = [];
            ...
            >
              <td className="py-3 px-4">
                <button
                  ...
                  className={`text-left text-amber-100 hover:text-amber-50 hover:underline ${selectedConceptId === pair.concept1.id ? "font-semibold text-amber-200" : ""
                    }`}
                >
                  {pair.concept1.name}
                </button>
              ...
              <td className="py-3 px-4">
                <button
                  ...
                  className={`text-left text-amber-100 hover:text-amber-50 hover:underline ${selectedConceptId === pair.concept2.id ? "font-semibold text-amber-200" : ""
                    }`}
                >
                  {pair.concept2.name}
                </button>
