    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          disabled={disabled}
          className="flex-1 h-2 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed"
          style={{
            background: `linear-gradient(to right, rgb(8 145 178) 0%, rgb(8 145 178) ${value}%, rgb(39 39 42) ${value}%, rgb(39 39 42) 100%)`,
          }}
        />
        <button
          type="button"
