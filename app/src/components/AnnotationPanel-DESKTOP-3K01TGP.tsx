          ...
          <div className="bg-zinc-900 border border-amber-900/30 rounded-xl p-6 w-full max-w-md mx-4 shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                title="Close save to journal modal"
                aria-label="Close"
              >
                <X className="w-5 h-5" />
              </button>
                ...
                <div>
                  ...
                  {loadingPages ? (
                    ...
                    <select
                      ...
                      title="Select an existing journal page"
                    >
        ...
        <div className="mb-4 p-4 bg-zinc-800/50 border border-amber-900/10 rounded-lg space-y-3">
          ...
          <div>
            ...
            <select
              ...
              title="Select annotation category"
            >
              {ANNOTATION_CATEGORIES.map((cat) => (
...
function VirtualizedAnnotationList({
  ...
  return (
    <div
      ref={parentRef}
      className="space-y-4 h-[500px] overflow-auto"
    >
      <div
        style={{
        ...
        {virtualizer.getVirtualItems().map((virtualItem) => {
          ...
          return (
            <div
              ...
              className="absolute top-0 left-0 w-full h-[var(--item-size)] translate-y-[var(--item-start)] mb-4"
            >
