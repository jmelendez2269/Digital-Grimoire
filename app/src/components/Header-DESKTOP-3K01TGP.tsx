...
function Header({ librarySearch }: HeaderProps = {}) {
  ...
  return (
    <header className="sticky top-0 z-50 pt-4 px-4 pb-2 bg-gradient-to-b from-black/80 to-transparent pointer-events-none">
      <nav className="pointer-events-auto mx-auto flex flex-col max-w-7xl px-4 py-3 glass-panel rounded-3xl relative">
        ...
        <div className="flex items-center justify-between mb-3">
          {/* Logo Section with Parallax Engine Link */}
          <div className="flex flex-col gap-0.5">
            ...
            {/* Parallax Engine Link */}
            <Link
              href="/parallax-engine"
              className="ml-11 flex items-center gap-1.5 text-xs font-mono text-cyan-400 hover:text-cyan-300 transition-colors group"
            >
              <span className="group-hover:drop-shadow-[0_0_8px_rgba(34,211,238,0.6)]">⚡</span>
              <span className="group-hover:drop-shadow-[0_0_8px_rgba(34,211,238,0.4)]">Parallax Engine</span>
            </Link>
          </div>
        ...
        {/* Subtle Divider */}
        <div className="h-[1px] bg-gradient-to-r from-transparent via-white/5 to-transparent mb-3"></div>

        {/* Bottom Row: Desktop Navigation (HUD Tabs) */}
