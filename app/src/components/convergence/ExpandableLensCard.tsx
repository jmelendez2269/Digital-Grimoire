...
export default function ExpandableLensCard({
  ...
  return (
    <div className="bg-zinc-900/30 border border-cyan-500/20 rounded-xl p-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-cyan-600/20 hover:bg-cyan-600/30 border border-cyan-500/30 rounded-lg text-sm text-amber-100 transition-colors"
        >
