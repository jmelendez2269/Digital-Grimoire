...
import { ArrowRight, BookOpen, Lightbulb, Network, Tablet } from "lucide-react";
...
const INTRODUCTION_COURSE_SLUG = "pre-how-to-hold-two-things-at-once";
    ...
    <>
      ...
      <div className="flex flex-1 flex-col px-6 py-10">
        <div className="mx-auto w-full max-w-7xl">
          ...
          <section className="mb-16" aria-labelledby="current-shared-path">
            <p
            ...
            <article className="relative mt-5 overflow-hidden rounded-3xl border border-amber-300/20 bg-zinc-950/75 p-7 shadow-2xl shadow-black/20 sm:p-10 lg:p-12">
              ...
              <div className="relative">
                ...
                {showIntroductionNote ? (
                  <p className="mt-8 border-t border-white/10 pt-7 text-sm leading-6 text-zinc-500">
                    New here? How to Hold Two Things at Once stays open as the
                    introduction.{" "}
                    <Link
                      href={`/courses/${INTRODUCTION_COURSE_SLUG}`}
