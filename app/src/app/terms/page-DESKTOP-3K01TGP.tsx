...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Terms of Service for Project Parallax - Rules and guidelines for using our platform",
    type: "website",
    url: "https://www.projectparallax.io/terms",
    images: [
      {
        ...
        <div className="prose prose-invert prose-amber max-w-none">
          ...
          <section className="mt-8">
            ...
            <p className="text-zinc-300 mt-4">
              ...
              <a href="mailto:legal@digitalgrimoire.io" className="text-amber-400 hover:text-amber-300">
                legal@digitalgrimoire.io
              </a>{" "}
          ...
          <section className="mt-8">
            ...
            <p className="text-zinc-300">
              You agree to indemnify, defend, and hold harmless Project Parallax and its operators, employees, and contributors from and
