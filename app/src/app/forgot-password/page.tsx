  ...
  const handleResetRequest = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (resetError) {
        ...
        if (isRateLimit) {
          setError("Email rate limit exceeded. Please wait 1 hour before requesting another password reset link. This limit helps protect against spam.");
        } else {
                    ...
                    <div className="flex-1">
                      ...
                      {error.toLowerCase().includes('rate limit') && (
                        <p className="mt-2 text-xs text-red-300/80">
                          💡 Tip: If you're already logged in, you may not need to reset your password. Try refreshing the page or contact support if you need immediate assistance.
                        </p>
                      )}
                    </div>
                  </div>
