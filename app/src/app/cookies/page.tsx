...
export const metadata: Metadata = {
  title: "Cookie Policy | Project Parallax",
  description: "Cookie Policy for Project Parallax - Learn about how we use cookies",
  openGraph: {
    title: "Cookie Policy | Project Parallax",
    description: "Cookie Policy for Project Parallax - Learn about how we use cookies",
    type: "website",
    url: "https://www.projectparallax.io/cookies",
    images: [
      {
        url: "https://www.projectparallax.io/og-image.png",
        width: 1200,
        height: 630,
        alt: "Project Parallax Cookie Policy",
      },
    ],
  },
  twitter: {
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert prose-amber max-w-none">
          ...
          <section className="mt-8">
            ...
            <p className="text-zinc-300">
              Project Parallax uses cookies to enhance your experience, analyze site usage, and assist in
          ...
          <div className="mt-12 pt-8 border-t border-zinc-800">
            <p className="text-zinc-400 text-sm">
              This Cookie Policy is effective as of {currentDate} and applies to all users of the Project Parallax platform.
            </p>
            <div className="mt-4">
              <Link
                href="/privacy"
