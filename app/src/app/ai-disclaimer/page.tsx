...
export const metadata: Metadata = {
  title: "AI Disclaimer | Project Parallax",
  description: "AI Disclaimer for Project Parallax - Understanding the limitations and nature of AI-generated content",
  openGraph: {
    title: "AI Disclaimer | Project Parallax",
    description: "AI Disclaimer for Project Parallax - Understanding the limitations and nature of AI-generated content",
    type: "website",
    url: "https://www.projectparallax.io/ai-disclaimer",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        ...
        <div className="prose prose-invert prose-amber max-w-none">
          ...
          <section className="mt-8">
            ...
            <p className="text-zinc-300">
              Welcome to Project Parallax's AI Disclaimer and Discernment Guide. This page is designed to help you understand
          ...
          <section className="mt-8">
            ...
            <p className="text-zinc-300">
              Discernmentâ€”the ability to judge wellâ€”is crucial when engaging with AI-generated content. AI systems,
              including the Parallax Engine, generate responses based on patterns in their training data, not on
              genuine understanding or direct experience of truth.
            </p>
            <p className="text-zinc-300 mt-2">
              When you use AI tools on Project Parallax, we encourage you to:
            </p>
            <ul className="list-disc pl-6 text-zinc-300 space-y-2 mt-2">
              ...
              <li><strong>Seek multiple perspectives</strong> - Use the Parallax Engine's seven lenses to see different viewpoints</li>
            </ul>
          ...
          <section className="mt-8">
            <h2 className="text-2xl font-semibold text-amber-200 mt-8 mb-4">How the Parallax Engine Works</h2>

            <h3 className="text-xl font-semibold text-amber-300 mt-6 mb-3">Model Information</h3>
            <p className="text-zinc-300">
              The Parallax Engine is powered by <strong>GPT-4o (GPT-4 Omni)</strong>, a large language model developed
            ...
            <p className="text-zinc-300">
              When you submit a question to the Parallax Engine:
            </p>
          ...
          <section className="mt-8">
            ...
            <ul className="list-disc pl-6 text-zinc-300 space-y-2 mt-2">
              ...
              <li><strong>Confidence doesn't equal accuracy</strong> - LLMs can generate highly confident-sounding responses
                that are completely wrong. The model doesn't "know" it's wrongâ€”it's just continuing a pattern.</li>
            ...
            <p className="text-zinc-300 mt-4">
              This doesn't mean AI isn't usefulâ€”it can be an excellent tool for exploration, synthesis, and generating ideas.
          ...
          <section className="mt-8">
            ...
            <ul className="list-disc pl-6 text-zinc-300 space-y-2 mt-2">
              <li><strong>Fine-tuning with library content</strong> - We plan to fine-tune a model (to be determined) using
                the curated texts in the Project Parallax library. This will help the AI better understand and synthesize the specific
                knowledge traditions we curate.</li>
              <li><strong>Fine-tuning with parallax graph data</strong> - As we build the parallax graph (a knowledge
          ...
          <section className="mt-8">
            ...
            <div className="bg-amber-900/20 border border-amber-700/50 rounded-lg p-4 my-4">
              <p className="text-amber-200 font-semibold mb-2">âš ï¸ Important Safety Information</p>
              <p className="text-zinc-300">
          ...
          <section className="mt-8">
            ...
            <div className="bg-zinc-900/50 border border-amber-900/20 rounded-lg p-6 mt-4">
              ...
              <p className="text-zinc-300 mt-2">
                <strong>Email:</strong> <a href="mailto:info@digitalgrimoire.io" className="text-amber-400 hover:text-amber-300">info@digitalgrimoire.io</a>
              </p>
          ...
          <section className="mt-8">
            ...
            <div className="bg-amber-900/20 border border-amber-700/50 rounded-lg p-4 my-4">
              <p className="text-amber-200 font-semibold mb-2">âš ï¸ Legal Disclaimer</p>
              <p className="text-zinc-300">
            ...
            <p className="text-zinc-300 mt-4">
              <strong>Your use of Project Parallax's AI features is at your own risk.</strong> The AI systems are provided "as is"
            ...
            <p className="text-zinc-300 mt-4">
              ...
              above limitations may not apply to you. However, to the maximum extent permitted by law, you agree that Project Parallax
              shall not be liable for any harm resulting from your use of AI features.
            </p>

            <p className="text-zinc-300 mt-4">
              By using Project Parallax's AI features, you acknowledge that you have read and understood these disclaimers and agree
          ...
          <section className="mt-8">
            ...
            <p className="text-zinc-300 mt-4">
              ...
              <a href="mailto:info@projectparallax.io" className="text-amber-400 hover:text-amber-300">
                info@projectparallax.io
              </a>.
            </p>
            <p className="text-zinc-300 mt-2">
