...
export default function RitualMachinePage() {
    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-neutral-100 selection:bg-amber-900/40">
            <Header />
            <DocumentationLink href="/wiki/user/ritual-machine" label="Ritual Guide" className="container mx-auto px-4 py-2" />
