                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="flex items-end gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        <select
                          value={coverProvider}
                          onChange={(e) => setCoverProvider(e.target.value)}
                          className="px-3 py-2 bg-zinc-800 border border-amber-900/30 rounded-lg text-amber-100 text-sm focus:outline-none focus:border-amber-600/50"
                          disabled={generatingAICover}
                          aria-label="Select AI Provider"
                          title="Choose AI Provider"
                        >
                          <option value="replicate">Replicate (Stable)</option>
                          <option value="nano-banana">Nano Banana (Beta)</option>
                        </select>
                        <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {availableLenses.map((lens) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${lenses.includes(lens)
