...
│    🚀 projectparallax.xyz (production)                   │
...
```
main (production)     → Auto-deploys to projectparallax.xyz
  ↑
...
|--------|---------|------------|-------------|
| **main** | Production-ready code | `projectparallax.xyz` | Only after testing on develop |
...
2. Pushes to GitHub
3. Vercel automatically deploys to `projectparallax.xyz`
...
**When you're ready to deploy your local changes to production (projectparallax.xyz):**
...
- **Vercel** detects the push and deploys to `projectparallax.xyz`
...
1. **Pushes to `main`** → Deploys to **Production** (`projectparallax.xyz`)
   - Builds the app
...
Vercel Build & Deploy
    ↓
Live Website (projectparallax.xyz)
```
...
3. **Vercel automatically deploys**
   ...
   - Automatically builds and deploys to `projectparallax.xyz`
