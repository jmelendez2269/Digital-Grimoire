# The 7 Convergence Lenses Feature
...
The 7 Convergence Lenses feature connects the Library with The Convergence Machine by tagging each document with the perspectives through which it can be understood. This enables users to filter the library by perspective and creates a foundation for the AI reasoning system.
...
## Connection to The Convergence Machine

The lenses feature creates a foundation for The Convergence Machine (Phase 4):

### Future Integration

1. **Lens-Weighted Retrieval:** When users query The Convergence Machine and adjust lens weights, the system can prioritize documents tagged with those lenses
...
- **Technical Plan:** `docs/source/Complete_Technical_Implementation_Plan.md` - Convergence Machine
