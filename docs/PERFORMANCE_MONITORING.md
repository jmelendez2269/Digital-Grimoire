...
Digital Grimoire now includes comprehensive performance monitoring using **Vercel Speed Insights** and **Web Vitals** tracking. This setup allows you to monitor Core Web Vitals and custom performance metrics across your application.
...
```1:6:Digital-Grimoire/app/src/app/layout.tsx
...
```43:44:Digital-Grimoire/app/src/app/layout.tsx
        <SpeedInsights />
        <Analytics />
```
