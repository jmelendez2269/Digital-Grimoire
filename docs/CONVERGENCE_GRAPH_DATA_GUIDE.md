# Convergence Graph - Data Seeding Guide
...
The Convergence Graph visualizes how concepts from different wisdom traditions converge and relate to each other. This guide shows you how to add your first concepts and relationships.
...
### `convergence_relationships` Table
...
1. **Visit the Convergence Graph page:** `/convergence-graph`
2. **Use the controls:**
